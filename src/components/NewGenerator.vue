...
async function handleGenerate() {
  ...
  try {
    ...
    generatedContent.value = `# ${siteUrl.value}\n\n> Generated llms.txt content\n\n## Overview\n\nThis is a placeholder for the generated llms.txt content.\nConnect your API endpoint to see real results.\n\n## Sections\n\n- /docs\n- /api\n- /blog\n- /about\n\n## Usage\n\nThis file helps AI models understand your site structure.\n\n---\n\n*Generated by llms.txt generator*`
  } catch (err) {
    errorMessage.value = 'Failed to generate. Please check the URL and try again.'
  } finally {
